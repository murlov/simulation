...
public class Spawner {
    public static void execute(SimulationMap simulationMap, EntityGroup entityGroup, Coordinates coordinates, MoveListenerRegistry listenerRegistry) {
        ...
        simulationMap.countInGroupIncrement(entityGroup);
